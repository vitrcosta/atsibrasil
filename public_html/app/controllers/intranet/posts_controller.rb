class Intranet::PostsController < Intranet::IntranetController
  ...
  def post_params
    params.require(:post).permit(:titulo, :subtitulo, :descricao, :data, :inativar, :keywords, :kind_of_post_id, :category_id, :category_ativo_inativo, :foto_principal, :foto, :galleries_attributes => [:image, :id, :_destroy ])
  end
end
